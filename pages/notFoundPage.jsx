  ...
  return (
    <div className="w-full h-[calc(100vh-100px)] flex justify-center items-center gap-4 p-4">
        <div className="flex flex-col justify-center items-center gap-4 bg-white p-10 rounded-2xl shadow-lg">
            ...
            <p className="text-center text-secondary mb-2">The page you are looking for does not exist or has been moved.</p>
            <Link to="/" className="h-[40px] w-[100px] flex items-center justify-center bg-accent text-white rounded-md hover:bg-accent/90">Home Page</Link>
        </div>     
    </div>
  )
}
