      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mt-4 text-secondary">
          ...
          <div>
            ...
            <div className='flex flex-row'>
              ...
              <select value={status} disabled={true} onChange={(e=>{setStatus(e.target.value)})} className='ml-4 px-2 py-1 border border-secondary/20 outliine-none rounded-lg text-sm text-secondary'>
        ...
        {/* Notes */}
          <div className="mt-4 p-3 bg-primary rounded-lg border">
            ...
            <textarea className="w-full text-secondary outline-0" value={order.notes} disabled={true}></textarea>
          </div>
