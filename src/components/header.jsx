...
export default function Header() {
    ...
    return(
        <header className="w-full h-[100px] bg-accent flex items-center relative">
            ...
            <div className="fixed lg:hidden top-0 left-0 w-full h-screen z-20 pointer-events-none">
            <div
            ...
            <div className="relative w-[250px] h-screen">
                <div className={`absolute top-0 left-0 h-full w-[250px] bg-white transition-transform duration-1000 ${sideBarOpen ? "translate-x-0" : "-translate-x-full"}`}
                >
                ...
                <div className="w-full h-full flex flex-col text-xl text-secondary pl-6 pt-2 gap-3">
                    ...
                    >
                    <FaChevronRight className={`text-sm ${page === "home" ? "opacity-100" : "opacity-0"}`} />
                    Home
                    </Link>
                    ...
                    >
                    <FaChevronRight className={`text-sm ${page === "products" ? "opacity-100" : "opacity-0"}`} />
                    Products
                    </Link>
                    ...
                    >
                    <FaChevronRight className={`text-sm ${page === "contacts" ? "opacity-100" : "opacity-0"}`} />
                    Contact
                    </Link>
                </div>
                </div>
